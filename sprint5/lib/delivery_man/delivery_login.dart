...
import 'package:new_pro/signup.dart';
                ...
                children: [
                  GestureDetector(
                    child: Text(
                      'Forget Password',
                      style: TextStyle(
                          color: Colors.orange, fontSize:16.0, fontStyle: FontStyle.italic),
                    ),
                    onTap: () {
                      Navigator.push(
                        context,
            ...
            Container(
              child: GestureDetector(
                child: Text(
                  'Back to User Login',
                  style: TextStyle(
                      color: Colors.orange, fontSize:18.0, fontStyle: FontStyle.italic),
                ),
                onTap: () {
                  Navigator.push(
                    context,
